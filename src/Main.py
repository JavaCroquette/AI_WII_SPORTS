...
def main():
    ...
    Video_thread = video(MOT_DOUX, './Exercice1/video2.mp4',
                         './Exercice1/video.npy')
#==============================================================================#
    Camera = None
    data = None
        ...
        if Video is not None and Camera is not None:
            if check:
                ...
                print("Camera : " + str(Camera_thread.frame_count) +
                      " == Video : " + str(Video_thread.frame_count))
#==============================================================================#
            cv2.putText(Video, str(
                MOT_DOUX[i]), (100, 100), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 0), 4)
            cv2.putText(Video, str(round(sum, 2)), (100, 200),
            ...
            Video[0:data.shape[0], Video.shape[1] -
                  data.shape[1]:Video.shape[1]] = data
#==============================================================================#
            img = IMAGE[i]
            Video[250:img.shape[0]+250, img.shape[1] +
