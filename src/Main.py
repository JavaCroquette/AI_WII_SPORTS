...
#==============================================================================#
    while True:
        if len(Camera_thread.ListPoint) != 0:
            Camera = Camera_thread.ListPoint[0][0]#On check si il y a des cordonnées
...
#==============================================================================#
            if Camera > 0:
                ...
                for y in range(0,len(CameraPoint)):
                    cv_keypoints.append(cv2.KeyPoint(CameraPoint[y][1]*500, CameraPoint[y][0]*500+Video.shape[0]-500, 10))
                    Liste.append([int(CameraPoint[y][1]*500), int(CameraPoint[y][0]*500+Video.shape[0]-500)])
